...
> Detachment reduces the compression of impurities in the divertor region \cite{Bosh2001} so impurity transport during detachment requires further analysis.
