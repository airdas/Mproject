...
\begin{figure}
\includegraphics[scale=0.7]{Figures/sol1d/neprofneusALLtriang.png}
\centering
...
\begin{figure}
\includegraphics[scale=0.75]{Figures/MASTUdesignpapersFig2.png}
\centering
